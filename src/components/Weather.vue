...
<template>
    <div id="main" :class="isDay ? 'day':'night' " class="max-w-7xl mx-auto my-0 left-0 right-0 section-top-header">
    <div class="max-w-xl mx-auto mb-0 mt-10 pt-10">
      <h1 class="title text-center">Weather in</h1>
      <form class="search-location text-center" v-on:submit.prevent="getWeather">
        <input
          type="text"
      ...
      <div class="card form-rounded my-3 shadow-lg back-card overflow-hidden flex flex-col relative border max-w-xl mx-auto my-0" v-if="visible">
